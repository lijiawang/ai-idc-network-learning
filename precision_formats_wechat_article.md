...
![为什么有这么多精度](precision-diagrams/00_why_many_precisions.png)
...
FP 是 Floating Point，中文叫**浮点数**。可以把它理解成计算机里的“二进制科学计数法”。
...
![浮点数三部分](precision-diagrams/01_float_parts_wechat.png)
...
![常见数字格式的位宽分配](precision-diagrams/02_format_bits.png)
...
![BF16 vs FP16](precision-diagrams/03_bf16_vs_fp16.png)
...
![INT8 / INT4 的 scale 量化](precision-diagrams/05_int_quantization_scale.png)
...
## 8. 范围 vs 精度：它们到底在取舍什么？

![范围 vs 精度](precision-diagrams/04_range_precision_map.png)
...
![训练和推理里怎么用](precision-diagrams/06_training_inference_map.png)
